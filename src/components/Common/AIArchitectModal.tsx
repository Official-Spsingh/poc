...
const AIArchitectModal: React.FC<AIArchitectModalProps> = ({
  isOpen,
  title = 'Architecting',
  description = 'Synthesizing your application structure...',
    ...
    <div data-theme={resolvedTheme} className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6 selection:bg-transparent">
      ...
      >
        ...
        <div className="relative mb-10">
          ...
          <div className="w-24 h-24 bg-mod-hero-badge-bg border border-mod-hero-badge-bg rounded-2xl flex items-center justify-center relative shadow-inner">
        ...
        <div className="text-center space-y-6 max-w-sm relative z-10">
          <div className="space-y-2">
            <h3 className="text-2xl font-bold text-mod-surface-text-primary tracking-tight flex items-center justify-center gap-2">
              <span className="text-mod-hero-icon-color italic">AI</span> {title}
            </h3>
