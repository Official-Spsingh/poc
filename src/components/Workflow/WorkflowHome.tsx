      ...
      {isAiPromptMode && isGenerating && createPortal(
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6 selection:bg-transparent">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-white rounded-3xl shadow-[0_0_50px_rgba(20,184,166,0.15)] overflow-hidden flex flex-col items-center justify-center p-12 lg:p-16"
          >
            {/* AI Grid/Pattern Overlay */}
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{ backgroundImage: 'radial-gradient(#14b8a6 1px, transparent 1px)', backgroundSize: '24px 24px' }} />
            
            <div className="relative mb-10">
              <div className="absolute inset-0 bg-teal-500 rounded-full blur-[60px] opacity-10 animate-pulse" />
              <div className="w-24 h-24 bg-teal-50 border border-teal-100 rounded-2xl flex items-center justify-center relative shadow-inner group">
                <Sparkles size={48} className="text-teal-600 animate-pulse" />
                <motion.div 
                  animate={{ rotate: 360 }}
                  transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
                  className="absolute inset-0 border-2 border-dashed border-teal-200/50 rounded-2xl scale-125"
                />
              </div>
            </div>
            ...
            <div className="text-center space-y-6 max-w-sm relative z-10">
              <div className="space-y-2">
                <h3 className="text-2xl font-bold text-gray-900 tracking-tight flex items-center justify-center gap-2">
                  <span className="text-teal-600 italic">AI</span> Architecting
                </h3>
              ...
              <div className="pt-4 flex flex-col items-center gap-4">
                ...
                <div className="text-[10px] font-bold text-teal-600/60 uppercase tracking-[0.2em] font-mono">
            ...
            {/* Bottom Accent */}
            <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-teal-500/20 to-transparent" />
          </motion.div>
        </div>,
        document.body
      )}
