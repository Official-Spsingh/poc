                ...
                <div className="flex gap-6 min-w-max pt-1 pb-8">
                  {options.map((option) => (
                    ...
                    >
                      ...
                      <div className="w-16 h-16 bg-mod-hero-btn-bg rounded-2xl flex items-center justify-center text-white mb-8 shadow-lg group-hover:scale-110 transition-transform">
                        {React.cloneElement(option.icon as React.ReactElement, { className: 'w-8 h-8' })}
                      </div>
                      <h3 className="text-2xl font-bold text-dash-title mb-3">{option.title}</h3>
                      <p className="text-dash-subtext leading-relaxed mb-8 text-sm">{option.description}</p>
                      <div className="flex items-center justify-between mt-auto">
                        <div className="flex items-center gap-2 text-mod-hero-icon-color font-bold text-sm group-hover:gap-4 transition-all">
                      ...
                      <div className="absolute -right-8 -bottom-8 w-32 h-32 bg-mod-hero-btn-bg opacity-[0.03] rounded-full group-hover:scale-150 transition-transform" />
                    </div>
                  ))}
                </div>
              </div>
            ...
            >
              {options.map((option) => (
                <div
                  ...
                  data-theme={option.moduleTheme}
                  onClick={() => onNavigate(option.id)}
                  className="group relative bg-dash-card-bg p-6 md:p-8 rounded-2xl md:rounded-3xl border border-dash-card-border dash-card-shadow-hover hover:border-mod-hero-icon-color/50 transition-all text-left overflow-hidden cursor-pointer flex flex-col"
                >
                  ...
                  <p className="text-dash-subtext leading-relaxed mb-6 md:mb-8 text-xs md:text-sm">{option.description}</p>
                  <div className="flex items-center justify-between mt-auto">
